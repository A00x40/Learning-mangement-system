...
const PlusCard = ({text, clickHandler}) => {
    return (
        ...
        <div className={`pointer no_text_decoration ${styles.plus_card} ${styles.clickHandler} cursor_pointer`} onClick={clickHandler}>

            <img className={styles.plus} src='/images/plus.svg' alt='Plus'/>
            <p className={`font2_white bold center_text no_margin`}>{text}</p>
